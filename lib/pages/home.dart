...
import '../widgets/custom_money_display.dart';
...
class _HomePageState extends State<HomePage> {
  var buttonStyleInactive = ElevatedButton.styleFrom(
      ...
      shadowColor: ColorsRandom.brandLightColor);
  var buttonStyleActive = ElevatedButton.styleFrom(
      backgroundColor: ColorsRandom.brandSecondaryColor,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: ColorsRandom.brandLightBackgroundColor,
      appBar: AppBar(
        toolbarHeight: 97,
            ...
            ElevatedButton(
                ...
                child: const Padding(
                  ...
                  child: Text(
                    'Categories',
                    style: TextStyle(
                        color: ColorsRandom.brandDarkColor, fontSize: 14),
                  ),
                )),
            ElevatedButton(
                ...
                child: const Padding(
                  ...
                  child: Text(
                    'Recent transaction',
                    style: TextStyle(
                        color: ColorsRandom.brandLigthDarkColor, fontSize: 14),
                  ),
                )),
          ],
        ));
