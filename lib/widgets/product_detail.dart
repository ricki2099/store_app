...
class ProductDetailCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var currentBgPercentageColor = ColorsRandom.brandSuccessColor;
    var currentTextPercentageColor = ColorsRandom.brandOnSuccessColor;
    var currentIcon = iconIncomes;
    if (typeProductDetailCard == TypeProductDetailCard.outcomes) {
      currentBgPercentageColor = ColorsRandom.brandErrorColor;
      currentTextPercentageColor = ColorsRandom.brandOnErrorColor;
